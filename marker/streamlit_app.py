...
page_range = st.sidebar.text_input("Page range to parse, comma separated like 0,5-10,20", value=None)
...
llm_service = st.sidebar.text_input(
    "LLM Service",
    value="marker.services.ollama.OllamaService"
)
